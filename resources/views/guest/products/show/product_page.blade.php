        ...
        <div class="product-page__slider-wrap">
            <div class="product-page__sticky-wrap"
                ...
                <div class="product-page__slider" id="c9b886c8-f0ab-8c86-91cd-ac1f72dc8e1b">
                    <div class="sw-slider-kt-mix"><p class="badge-express-sm hide"
                        ...
                        <p class="badge-abroad-sm hide"
                           ...
                           data-jsv="#5426^/5426^">Доставка из-за рубежа</p>
                        <button class="swiper-button-prev disabled" type="button" tabindex="-1" role="button"
                                aria-label="Previous slide" aria-disabled="true">Предыдущий слайд
                        </button>
                        <div class="sw-slider-kt-mix__wrap">
                            <div
                                class="swiper-container j-sw-images-carousel swiper-container-initialized swiper-container-vertical">
