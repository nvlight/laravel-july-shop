           ...
           href="https://www.wildberries.ru/catalog/24811954/detail.aspx?targetUrl=GP">
            ...
            <div class="product-card__brand">
                ...
                <div class="product-card__brand-name">
                    <strong class="brand-name">ИД Городец <span>/ </span></strong>
                    <span class="goods-name">Уран</span>
                </div>
            </div>
            <span class="product-card__rating stars-line star5"></span>
            <span
                class="product-card__count">2</span>
            <p class="product-card__delivery">Доставка <b
                    class="product-card__delivery-date">завтра</b>
            </p>
